...
/**
 * Classe Util Abstrata para não ser instânciada; Converte Calendar em String e
 * String em Calendar;
 * 
...
public abstract class CalendarUtil {
	...
	/**
	 * O padrão usado para conversão de data. /* dd/MM/yyyy
	 */
	private static final String DATE_PATTERN = "dd/MM/yyyy";

	/**
	 * O padrão usado para conversão de tempo. /* hh:mm:ss
	 */
	 ...
	 */
	public static String formatCalendarToStringDate(Calendar c) {
		if (c == null)
			return null;
	 ...
	 */
	public static String formatCalendarToStringTime(Calendar c) {
		if (c == null)
			return null;
	...
	public static String formatCalendarToTimeAndDate(Calendar c) {
		if (c == null)
			return null;

		return "Data: " + formatCalendarToStringDate(c) + " - Hora: "
				+ formatCalendarToStringTime(c);
	}
